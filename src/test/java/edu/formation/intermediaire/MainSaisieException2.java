...
/**
 * Gestion personnalisée d'exceptions avec le paramètre DEBUG passé en paramètre au lancement.
 * @author Seme
 *
 */
public class MainSaisieException2 {
  ...
  public static void main(String[] args) {
    ...
    if (args != null && args.length > 0) {
      // si l'argument DEBUG est présent en première position
      if (args[0].equals("DEBUG")) {
        // je passe en mode DEBUG
        debug = true;
      }
    }
    int resultat = 0;
